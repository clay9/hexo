...
;; 目录导航
;; *************************
;; 1.helm-buffers 2.helm-find-files 3.helm-ff-run-grep
;; 4.format && color
(require 'helm)
(require 'helm-config)
...
(setq helm-boring-buffer-regexp-list
   (quote
    ("\\` " "\\`\\*helm" "\\`\\*Echo Area" "\\`\\*Minibuf" "\\*Messages\\*" "\\*GNU Emacs\\*"
     "\*Color\*" "BigDay" "\\*Completions\\*" "\*Org Agenda\*" "\*Flycheck error message\*" "Help" "Backtrace" "new snippet" "Calendar" "Fancy Diary Entries" "\*Org LATEX Export\*" "\*Customize Option\*" "\\*Warnings\\*" ".DS_Store" "task.org" "habit.org" "project.org" "trash.org" "inbox.org" "diary" "\*scratch\*")))
